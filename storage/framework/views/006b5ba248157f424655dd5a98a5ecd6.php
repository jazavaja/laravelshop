        ...
        <section class="topSingle width">
            <div class="imageContainer">
                <?php if($post->suggest): ?>
                    <div class="suggestProduct">
                        <h4><?php echo e(__('messages.suggest_product')); ?></h4>
                        <div class="countdown" data-time="<?php echo e($post->suggest); ?>"></div>
                    </div>
                <?php endif; ?>
                <div class="options">
                    ...
                    <div class="option" name="compareBtn" id="<?php echo e($post->product_id); ?>">
                        <svg class="icon">
                    ...
                    <div class="option" id="share" title="<?php echo e(__('messages.share')); ?>">
                        <svg class="icon">
                            <use xlink:href="#share"></use>
                        </svg>
                    </div>
                    <div class="option" id="charts" title="<?php echo e(__('messages.change_price')); ?>">
                        <svg class="icon">
            ...
            <div class="singleData">
                ...
                <div class="singleInfo">
                    <div class="right">
                        <div class="shortDetail">
                            <div class="itemDetail">
                                ...
                                <span><?php echo e($post->comments_count); ?> <?php echo e(__('messages.number')); ?></span>
                            </div>
                            <div class="itemDetail">
                                <?php echo e(__('messages.success_order')); ?> :
                                <span><?php echo e($pays1); ?> <?php echo e(__('messages.number')); ?></span>
                            </div>
                            <div class="itemDetail">
                                <?php echo e(__('messages.product_score')); ?> :
                                <span>
                        ...
                        <?php if($post->lotteryStatus == 1): ?>
                            <div class="lottery">
                                <div class="titleLottery">
                                    <h4><?php echo e($allLottery - $lastLottery); ?> <?php echo e(__('messages.lottery_exits')); ?> </h4>
                                </div>
                                <div class="allHorizontalDatas">
                                    <div class="allHorizontalDataItem" style="width : <?php echo e(($lastLottery * 100) / $allLottery); ?>%">
                                        <div></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gifOptions options">
                            ...
                            <?php if($post->used): ?>
                                <div class="originalItem">
                                    ...
                                    <p><?php echo e(__('messages.product_used')); ?></p>
                                </div>
                            <?php elseif($post->original): ?>
                                <div class="originalItem">
                                    <i>
                                        <svg class="icon">
                                            <use xlink:href="#shield"></use>
                                    ...
                                    <p><?php echo e(__('messages.product_original')); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="left">
                        <?php if($post->user): ?>
                            <a href="/mall/<?php echo e($post->user->slug); ?>" class="detailRightOptions">
                                <span><?php echo e(__('messages.seller1')); ?></span>
                        ...
                        <div class="leftData">
                            ...
                            <?php endif; ?>
                            <div class="leftDataItem">
                                <h4><?php echo e(__('messages.count_status')); ?> :</h4>
                                <?php if($post->count >= 1): ?>
                                    <span><?php echo e(__('messages.available')); ?></span>
                                <?php else: ?>
                                    <?php if($post->prebuy): ?>
                                        <span><?php echo e(__('messages.prebuy')); ?></span>
                                    <?php else: ?>
                                        <span><?php echo e(__('messages.unavailable')); ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                            <?php if($post->count >= 1): ?>
                                <div class="leftDataItem">
                                    <h4><?php echo e(__('messages.deliver_time')); ?> :</h4>
                                    <?php $__currentLoopData = $post['time']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span><?php echo e($time->name); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php else: ?>
                                <?php if($post->prebuy): ?>
                                    <div class="leftDataItem">
                                        <h4><?php echo e(__('messages.prepare_time')); ?> :</h4>
                                        <span><?php echo e($post->prepare); ?></span>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <div class="leftDataItem">
                                <h4><?php echo e(__('messages.product_code')); ?> :</h4>
                                <span><?php echo e($post->product_id); ?></span>
                            </div>
                        </div>
                        <?php if($post->note): ?>
                            <div class="note">
...
<?php echo $__env->make('home.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/home/single/product.blade.php ENDPATH**/ ?>