<?php $__env->startSection('tab',36); ?>
<?php $__env->startSection('content'); ?>
    <div class="allBarcodePanel">
        <div class="title">
            <div class="item" id="<?php echo e(request()->show == 0 ? 'activeB' : ''); ?>" data-num="0">متن</div>
            <div class="item" id="<?php echo e(request()->show == 1 ? 'activeB' : ''); ?>" data-num="1">آدرس</div>
            <div class="item" id="<?php echo e(request()->show == 2 ? 'activeB' : ''); ?>" data-num="2">تماس</div>
            <div class="item" id="<?php echo e(request()->show == 3 ? 'activeB' : ''); ?>" data-num="3">پیامک</div>
            <div class="item" id="<?php echo e(request()->show == 4 ? 'activeB' : ''); ?>" data-num="4">واتساپ</div>
            <div class="item" id="<?php echo e(request()->show == 5 ? 'activeB' : ''); ?>" data-num="5">موقعیت مکانی</div>
            <div class="item" id="<?php echo e(request()->show == 6 ? 'activeB' : ''); ?>" data-num="6">ایمیل</div>
            <div class="item" id="<?php echo e(request()->show == 7 ? 'activeB' : ''); ?>" data-num="7">فیس تایم</div>
        </div>
        <div class="content">
            <div>
                <div class="right">
            ...
            <div class="left">
                <div class="pics">
                    <div class="pic" id="printMe1">
                        ...
                        <?php elseif(request()->show == 0 || request()->show == 1): ?>
                            <?php echo DNS2D::getBarcodeHTML(request()->body, 'QRCODE',8,8); ?>

                        <?php elseif(request()->show == 2): ?>
                            <?php echo DNS2D::getBarcodeHTML('tel:'.request()->phone, 'QRCODE',8,8); ?>

                        <?php elseif(request()->show == 3): ?>
                            <?php echo DNS2D::getBarcodeHTML('sms:'.request()->phone, 'QRCODE',8,8); ?>

                        <?php elseif(request()->show == 4): ?>
                            <?php echo DNS2D::getBarcodeHTML('https://wa.me/'.request()->phone.'?text='.request()->body, 'QRCODE',8,8); ?>

                        <?php elseif(request()->show == 5): ?>
                            <?php echo DNS2D::getBarcodeHTML('https://www.google.com/maps/@'.request()->lat.','.request()->lng.',13.63z?entry=ttu', 'QRCODE',8,8); ?>

                        <?php elseif(request()->show == 6): ?>
                            <?php echo DNS2D::getBarcodeHTML('mailto:'.request()->email, 'QRCODE',8,8); ?>

                        <?php else: ?>
                            <?php echo DNS2D::getBarcodeHTML('facetime:'.request()->phone, 'QRCODE',8,8); ?>
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            var show1 = <?php echo json_encode($show1, JSON_HEX_TAG); ?>;
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/barcode/index.blade.php ENDPATH**/ ?>