    ...
    <div class="headerFix">
            ...
            <div class="block width">
                ...
                <form action="/search" method="GET">
                    <label for="searching">
                        ...
                        <input type="search" id="searching" name="search" placeholder="<?php echo e(__('messages.search_product')); ?>">
                        <select name="categorySearch">
                            <option value="0" selected><?php echo e(__('messages.all_cat')); ?></option>
                            <?php $__currentLoopData = $catTop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="left">
                    <div class="cityChoice">
                        ...
                        <div class="leftCity">
                            <h4><?php echo e(__('messages.select_loc')); ?></h4>
                            <h5><?php echo e(__('messages.filter_city')); ?></h5>
                        </div>
                    </div>
                    ...
                    <?php else: ?>
                        <a href="/login" class="login" name="<?php echo e(__('messages.login_user')); ?>" title="<?php echo e(__('messages.login_user')); ?>">
                            ...
                            <?php echo e(__('messages.login_user')); ?>
                    ...
                    <div class="headerCart">
                        <div class="headerCartItems">
                            <div class="cartShowBtn">
                                ...
                                <span><?php echo e(__('messages.header_cart')); ?></span>
                                <h5>0</h5>
                            </div>
                            <div class="showCart">
                                <ul id="showCartLi"></ul>
                ...
                <div class="allFilterCity">
                    <div class="filterCity">
                        <div class="titleAddress">
                            <span><?php echo e(__('messages.filter_city')); ?></span>
        ...
        <nav class="headerBot width">
            <ul class="headerList">
                ...
                <?php $__currentLoopData = $catHeader; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="/category/<?php echo e($lists->slug); ?>" name="<?php echo e($lists->name); ?>" title="<?php echo e($lists->name); ?>">
                            <?php echo e($lists->name); ?>

                            <?php if(count($lists->cats) >= 1): ?>
                                <i>
                                    <svg class="icon">
                                        <use xlink:href="#down"></use>
                                    </svg>
                            ...
                            <div class="divListContainer">
                                <div class="divListsContainer">
                                    <div class="listsContainer">
                                        <?php $__currentLoopData = $lists->cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="active" href="/category/<?php echo e($item->slug); ?>" name="<?php echo e($item->name); ?>" title="<?php echo e($item->name); ?>">
                                            ...
                                            <?php $__currentLoopData = $item->cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="/category/<?php echo e($value->slug); ?>" name="<?php echo e($value->name); ?>" title="<?php echo e($value->name); ?>"><?php echo e($value->name); ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function (){
        ...
        var stateContainer = <?php echo json_encode($stateContainer, JSON_HEX_TAG); ?>;
...
<?php /**PATH /var/www/html/resources/views/home/header/headerIndex.blade.php ENDPATH**/ ?>