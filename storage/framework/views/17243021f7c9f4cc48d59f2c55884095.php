    ...
    <div class="allBrandPanel">
        ...
        <div class="allTables">
            <div>
                <table>
                    ...
                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <div class="buttons">
                                    <a href="/admin/tag/<?php echo e($item->id); ?>/show">آمارگیری</a>
                ...
                <?php echo e($tags->links('admin.paginate')); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/taxonomy/index/tag.blade.php ENDPATH**/ ?>