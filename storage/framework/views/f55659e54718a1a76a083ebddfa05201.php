            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <textarea placeholder="توضیح را وارد کنید" name="body"></textarea>
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <input type="text" name="titleEn" placeholder="عنوان را وارد کنید">
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <input type="text" name="maxCart" placeholder="مثال : 10">
                                <div id="validation-maxCart"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>حداقل مقدار در سبد خرید* :</label>
                                <input type="text" name="minCart" value="1" placeholder="مثال : 10">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <div class="detailImages">
                                    <input type="text" name="image3d" placeholder="آدرس تصویر">
                                    <input type="text" name="imageCount3d" placeholder="تعداد کل تصاویر در عکس">
                                    <input type="text" name="imageFirstCount" placeholder="تعداد تصاویر در ردیف اول">
                                </div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>پیشنهاد</label>
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <div class="lotteryItems">
                                    <input type="text" name="letterLottery" placeholder="حرف را وارد کنید">
                                    <input type="text" name="numLottery1" placeholder="اولین عدد">
                                    <input type="text" name="numLottery2" placeholder="عدد شروع قرعه">
                                </div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>زمان آماده سازی(در حالت پیش خرید) :</label>
                                <input type="text" name="prepare" placeholder="مثال : 2 روز">
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>نکته مهم</label>
                                <input type="text" name="note" placeholder="توضیح را وارد کنید">
                            </div>
                            <div class="allCreatePostDetailItem">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <select class="guarantee-multiple" name="guarantees" multiple="multiple">
                                    <?php $__currentLoopData = $guarantees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guarantee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($guarantee->id); ?>"><?php echo e($guarantee->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="allCreatePostDetailItem">
            ...
            <div id="calcProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="priceBuy" placeholder="قیمت را وارد کنید">
                    </div>
                    <div class="allCreatePostItem">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="prePrice" placeholder="مبلغ را وارد کنید">
                    </div>
                    <div class="abilityPost">
                        <div class="abilityTitle">
            ...
            <div id="tankProduct" class="allCreatePostData" style="display: none">
                <div class="allTanks">
                    <div class="allCreatePostItem">
                        ...
                        <div id="validation-countTank"></div>
                    </div>
                    <div class="allCreatePostItem">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("button[name='createPost']").click(function(event){
                ...
                var prePrice = $(".allCreatePostData input[name='prePrice']").val();
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/post/create.blade.php ENDPATH**/ ?>