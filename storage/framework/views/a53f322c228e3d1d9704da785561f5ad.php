...
<?php $__env->startSection('content'); ?>
    <div class="allCreatePost">
        <form class="allCreatePost" action="/admin/user/<?php echo e($users->id); ?>/edit" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="allPostPanelTop">
                ...
                <div class="allPostTitle">
                    ...
                    <span>/</span>
                    <a href="/admin/user/<?php echo e($users->id); ?>/edit">ویرایش کاربر</a>
                </div>
            </div>
            <div class="allCreatePostData">
                <div class="allCreatePostSubject">
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="name" value="<?php echo e($users->name); ?>" placeholder="عنوان را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        <label>ایمیل :</label>
                        <input type="text" value="<?php echo e($users->email); ?>" name="email" placeholder="ایمیل را وارد کنید">
                        <div class="alert" id="validation-email"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>شماره تماس :</label>
                        <input type="text" value="<?php echo e($users->number); ?>" name="number" placeholder="شماره تماس را وارد کنید">
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            ...
            var fields = <?php echo \App\Models\Field::where('status' , 0)->get(); ?>;
            var permissions = [];
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>