        ...
        <div class="allCreatePost">
            <div class="allPostPanelTop">
                ...
                <div class="allPostTitle">
                    ...
                    <span>/</span>
                    <a href="/admin/product/<?php echo e($posts->id); ?>/edit">ویرایش محصول</a>
                </div>
            </div>
            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="keywordSeo" placeholder="با , جدا کنید" value="<?php echo e(old('keywordSeo', $posts->keywordSeo)); ?>">
                        <div id="validation-keywordSeo"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>alt تصویر :</label>
                        <input type="text" name="imageAlt" placeholder="عنوان را وارد کنید" value="<?php echo e(old('imageAlt', $posts->imageAlt)); ?>">
                        <div id="validation-imageAlt"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>توضیح اجمالی* :</label>
                        <textarea placeholder="توضیح را وارد کنید" name="body"><?php echo e($posts->short); ?></textarea>
                        <div id="validation-body"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>توضیحات :</label>
                        <textarea name="editor" class="editor"><?php echo e($posts->body); ?></textarea>
                    </div>
                ...
                <div class="allCreatePostDetails">
                    <?php if(\App\Models\Field::where('status' , 1)->count() >= 1): ?>
                        <div class="allCreatePostDetail">
                            <div class="allCreatePostDetailItemsTitle">
                                فیلد های اختصاصی
                            </div>
                            <div class="allCreatePostDetailItems">
                                <?php $__currentLoopData = \App\Models\Field::where('status' , 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <input type="text" name="titleEn" value="<?php echo e(old('titleEn', $posts->titleEn)); ?>" placeholder="عنوان را وارد کنید">
                                <div id="validation-titleEn"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>وزن :</label>
                                <input type="text" name="weight" value="<?php echo e(old('weight', $posts->weight)); ?>" placeholder="وزن را وارد کنید">
                            </div>
                            <div class="allCreatePostDetailItem">
                            ...
                            <div class="allCreatePostDetailItem">
                                <label>وضعیت* :</label>
                                <select name="status" id="status" value="<?php echo e(old('status', $posts->status)); ?>">
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            <div class="allCreatePostDetailItem">
                                ...
                                <input type="text" name="count" value="<?php echo e(old('count', $posts->count)); ?>" placeholder="تعداد را وارد کنید">
                                <div id="validation-count"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>امتیاز :</label>
                                <input type="text" name="score" value="<?php echo e(old('score', $posts->score)); ?>" placeholder="امتیاز را وارد کنید">
                                <div id="validation-score"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>حداکثر مقدار در سبد خرید* :</label>
                                <input type="text" name="maxCart" value="<?php echo e(old('maxCart', $posts->maxCart)); ?>" placeholder="مثال : 10">
                                <div id="validation-maxCart"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>حداقل مقدار در سبد خرید* :</label>
                                <input type="text" name="minCart" value="<?php echo e(old('minCart', $posts->minCart)); ?>" placeholder="مثال : 10">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <div class="detailImages">
                                    <input type="text" value="<?php echo e(old('image3d', $posts->image3d)); ?>" name="image3d" placeholder="آدرس تصویر">
                                    <input type="text" value="<?php echo e(old('imageCount3d', $posts->imageCount3d)); ?>" name="imageCount3d" placeholder="تعداد کل تصاویر در عکس">
                                    <input type="text" value="<?php echo e(old('imageFirstCount', $posts->imageFirstCount)); ?>" name="imageFirstCount" placeholder="تعداد تصاویر در ردیف اول">
                                </div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>پیشنهاد</label>
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <div class="lotteryItems">
                                    <input type="text" name="letterLottery" value="<?php echo e($posts->letterLottery); ?>" placeholder="حرف را وارد کنید">
                                    <input type="text" name="numLottery1" value="<?php echo e($posts->numLottery1); ?>" placeholder="اولین عدد">
                                    <input type="text" name="numLottery2" value="<?php echo e($posts->numLottery2); ?>" placeholder="عدد شروع قرعه">
                                </div>
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>زمان آماده سازی(در حالت پیش خرید) :</label>
                                <input type="text" name="prepare" value="<?php echo e($posts->prepare); ?>" placeholder="مثال : 2 روز">
                            </div>
                            <div class="allCreatePostDetailItem">
                                <label>نکته مهم</label>
                                <input type="text" name="note" value="<?php echo e($posts->note); ?>" placeholder="توضیح را وارد کنید">
                            </div>
                            <div class="allCreatePostDetailItem">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <select class="guarantee-multiple" name="guarantees" multiple="multiple">
                                    <?php $__currentLoopData = $guarantees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guarantees): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($guarantees->id); ?>"><?php echo e($guarantees->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="allCreatePostDetailItem">
            ...
            <div id="calcProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="off" value="<?php echo e($posts->off); ?>" placeholder="تخفیف را وارد کنید">
                    </div>
                    <div class="allCreatePostItem">
                        <label>قیمت خرید این محصول (جهت محاسبه سود از هر فروش) :</label>
                        <input type="text" name="priceBuy" value="<?php echo e($posts->priceBuy); ?>" placeholder="قیمت را وارد کنید">
                    </div>
                    <div class="allCreatePostItem">
                        <label>قیمت فروش به کاربر* :</label>
                        <div class="detailPrices">
                            <input type="text" name="price" value="<?php echo e($posts->priceCurrency); ?>" placeholder="قیمت را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="prePrice" value="<?php echo e($posts->prePrice); ?>" placeholder="مبلغ را وارد کنید">
                    </div>
                    <div class="abilityPost">
                        <div class="abilityTitle">
                ...
                <div class="allTanks">
                    <div class="allCreatePostItem">
                        ...
                        <div class="detailTank">
                            ...
                            <select name="tank_id">
                                <?php $__currentLoopData = \App\Models\Tank::where('parent_id' , 0)->select(['name','id'])->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="abilityPost">
                        ...
                        <table class="abilityTable" id="tank">
                            ...
                            <?php $__currentLoopData = \App\Models\Tank::where('parent_id' , '>=' , 1)->where('product_id' , $posts->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php if($el->tanks): ?>
                                        <td><?php echo e($el->tanks->name); ?></td>
                                    <?php else: ?>
                                        <td>-</td>
                                    <?php endif; ?>
                                    <td>
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            ...
            var fields = <?php echo \App\Models\Field::where('status' , 1 )->get(); ?>;
            var levels = <?php echo json_encode($levels, JSON_HEX_TAG); ?>;
            var levels1 = '';
            $('.filemanager').hide();
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/post/edit.blade.php ENDPATH**/ ?>