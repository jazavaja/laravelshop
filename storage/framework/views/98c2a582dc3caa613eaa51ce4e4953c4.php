            ...
            <div class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="note">
                        ...
                        <p><?php echo e(url('/fast?order=')); ?><span class="link1"></span></p>
                    </div>
                </div>
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <input type="text" name="property" placeholder="مثال : 22222210" value="<?php echo e(\App\Models\Pay::buildCode()); ?>">
                                <div id="validation-track"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/pay/create.blade.php ENDPATH**/ ?>