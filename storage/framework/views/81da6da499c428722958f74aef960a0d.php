    ...
    <div class="blockFooter width">
        <div class="topFooterIndex">
            <div class="item">
                ...
                <div>
                    <h3><?php echo e(__('messages.type_footer1')); ?></h3>
                    <h4><?php echo e(__('messages.status_footer1')); ?></h4>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <h3><?php echo e(__('messages.type_footer2')); ?></h3>
                    <h4><?php echo e(__('messages.status_footer2')); ?></h4>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <h3><?php echo e(__('messages.type_footer3')); ?></h3>
                    <h4><?php echo e(__('messages.status_footer3')); ?></h4>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <h3><?php echo e(__('messages.type_footer4')); ?></h3>
                    <h4><?php echo e(__('messages.status_footer4')); ?></h4>
                </div>
            </div>
        </div>
        <div class="midFooter">
            <div class="items">
                <h4><?php echo e(__('messages.fast1')); ?></h4>
                <ul>
            ...
            <div class="items">
                <h4><?php echo e(__('messages.trust1')); ?></h4>
                <div class="trustFooter">
                    <a><?php echo $etemad; ?></a>
                    <a><?php echo $fanavari; ?></a>
                </div>
            </div>
        </div>
        <div class="botFooter">
...
<?php /**PATH /var/www/html/resources/views/home/footer/footerIndex.blade.php ENDPATH**/ ?>