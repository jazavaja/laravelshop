...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="tankProduct" class="allCreatePostData" style="display: none">
                <div class="allTanks">
                    <div class="allCreatePostItem">
                        <label>تعداد ورود به انبار* :</label>
    ...
    <script>
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(typeG == 0){
                            ...
                            $(".allCreatePostDetailItems input[name='price']").val(data[6]);
                            ...
                            $(".allCreatePostDetailItems select[name='status']").val(1);
                            $(".allCreatePostDetailItems select[name='currency']").val(0);
                            $(".allCreatePostDetailItems input[name='price']").val(data[3]);
                            $(".allCreatePostDetailItems input[name='count']").val(10);
            ...
            $("button[name='createPost']").click(function(event){
                ...
                var prePrice = $(".allCreatePostDetailItem input[name='prePrice']").val();
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/post/copy.blade.php ENDPATH**/ ?>