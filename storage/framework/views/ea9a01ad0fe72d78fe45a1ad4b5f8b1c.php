    ...
    <div class="CreateAddress">
        ...
        <div class="form">
            ...
            <div class="addressField" style="display: none">
                ...
                <div class="item">
                    ...
                    <input id="address" type="text" placeholder="<?php echo e(__('messages.address')); ?>" name="address">
                    <div id="validation-address"></div>
                </div>
                <div class="items">
                    <div class="item">
                        <label for="plaque"><?php echo e(__('messages.plaque_address')); ?></label>
                        <input id="plaque" type="text" placeholder="<?php echo e(__('messages.plaque_address')); ?>" name="plaque">
                        <div id="validation-plaque"></div>
                    </div>
                    <div class="item">
                        <label for="unit"><?php echo e(__('messages.unit_address')); ?></label>
                        <input id="unit" type="text" placeholder="<?php echo e(__('messages.unit_address')); ?>" name="unit">
                    </div>
                    <div class="item">
                        <label for="post"><?php echo e(__('messages.post_address')); ?></label>
                        <input id="post" type="text" placeholder="<?php echo e(__('messages.post_address')); ?>" name="post">
                        <div id="validation-post"></div>
                    </div>
                </div>
                <div class="items">
                    <div class="item">
                        <label for="name"><?php echo e(__('messages.name_address')); ?></label>
                        <input id="name" type="text" placeholder="<?php echo e(__('messages.name_address')); ?>" name="name">
                        <div id="validation-name"></div>
                    </div>
                    <div class="item">
                        <label for="number"><?php echo e(__('messages.number_address')); ?></label>
                        <input id="number" type="text" placeholder="<?php echo e(__('messages.number_address')); ?>" name="number">
        ...
        <div class="bottomAddress">
            <div class="buttonRight" style="display:none;">
                <button id="btnCreateAddress"><?php echo e(__('messages.submit_address')); ?></button>
                <button id="btnEditAddress"><?php echo e(__('messages.edit_address')); ?></button>
            </div>
            <button id="showBtnAddress"><?php echo e(__('messages.show_address')); ?></button>
        </div>
    </div>
</div>
...
<?php $__env->startSection('script2'); ?>
    <script>
        $(document).ready(function(){
            var show_map1 = <?php echo json_encode(__('messages.show_map'), JSON_HEX_TAG); ?>;
            var address_added1 = <?php echo json_encode(__('messages.address_added'), JSON_HEX_TAG); ?>;
            ...
            var star_field1 = <?php echo json_encode(__('messages.star_field'), JSON_HEX_TAG); ?>;
            var address_edited1 = <?php echo json_encode(__('messages.address_edited'), JSON_HEX_TAG); ?>;
            var show_address1 = <?php echo json_encode(__('messages.show_address'), JSON_HEX_TAG); ?>;
            var addressData = <?php echo $address->toJson(); ?>;
            var originLat = 36.558976;
            var originLng = 53.064212;
            var app = new Mapp({
                element: '#map1',
                presets: {
                    latlng: {
...
<?php $__env->stopSection(); ?>
<?php /**PATH /var/www/html/resources/views/home/cart/addAddress.blade.php ENDPATH**/ ?>