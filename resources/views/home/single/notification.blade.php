<div class="singleNotification">
    <div class="singleNotificationItems">
        <div class="singleNotificationTitle">
            <h3>{{__('messages.note_suggest')}}</h3>
        </div>
        <i>
            <svg class="icon">
        ...
        <div class="singleNotificationData">
            <div class="singleNotificationItem">
                <label for="پیامک">
                    ...
                    {{__('messages.note_suggest2')}}
                </label>
            </div>
            <div class="singleNotificationItem">
                <label for="ایمیل">
                    <input id="ایمیل" type="checkbox">
                    {{__('messages.note_suggest3')}}
                </label>
            </div>
        </div>
        <div class="singleNotificationButtons">
            <button id="sendNot">{{__('messages.send')}}</button>
            <button id="cancelNot">{{__('messages.cancel')}}</button>
        </div>
    </div>
</div>
...
@section('script2')
    <script>
        $(document).ready(function(){
            ...
            var notice_suggest1 = {!! json_encode(__('messages.notice_suggest'), JSON_HEX_TAG) !!};
