...
@section('content')
                ...
                <div class="allCreateVariety">
                    ...
                    <div class="allCreateVarietyItems">
                        ...
                        <div class="allCreateVarietyItem">
                            ...
                            <input type="text" name="count" placeholder="{{__('messages.count')}}">
                        </div>
                    </div>
                    <div class="allCreateVarietyItems">
                        <div class="allCreateVarietyItem">
                            <h3>{{__('messages.price1')}}*</h3>
                            <input type="text" name="price" placeholder="{{__('messages.price1')}}">
                        </div>
                        <div class="allCreateVarietyItem">
                            <h3>{{__('messages.off')}}</h3>
                            <input type="text" name="off" placeholder="{{__('messages.off')}}">
                        </div>
                    </div>
                    <div class="abilityPost">
                        <div class="abilityTitle">
                            <label>{{__('messages.زخمخق')}}</label>
                            <i id="addColor">
                                <svg class="icon">
                    ...
                    <div class="buttons">
                        <button>{{__('messages.add_var')}}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var add_var = {!! json_encode(__('messages.add_var'), JSON_HEX_TAG) !!};
            ...
            $('#addColor').click(function (){
                $('#colors').append(
                    $('<tr><td><input type="text" name="name" placeholder="'+color3+'"></td><td><input name="color" type="color" placeholder="'+color_code+'"></td><td><input name="count" placeholder="'+count3+'"></td><td><input name="price" placeholder="قیمت را وارد کنید"></td><td><i id="deleteColor"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
            ...
            $(".buttons button").click(function(event){
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        $("button[name='createPost']").text(add_var);
                    }
                });
            });
        })
